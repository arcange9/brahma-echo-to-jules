...
#define MyAppPublisher "Arcange Tech Solutions"
...
Name: "{commondesktop}\Brahma Echo"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
Name: "{userstartup}\Brahma Echo"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\{#MyAppExeName}"; Tasks: startupicon
